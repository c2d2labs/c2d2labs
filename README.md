...
![GitHub stars](https://img.shields.io/github/stars/c2d2labs/c2d2labs?style=social)
![GitHub forks](https://img.shields.io/github/forks/c2d2labs/c2d2labs?style=social)
![GitHub issues](https://img.shields.io/github/issues/c2d2labs/c2d2labs)
![GitHub pull requests](https://img.shields.io/github/issues-pr/c2d2labs/c2d2labs)
![License](https://img.shields.io/github/license/c2d2labs/c2d2labs)
...
Our philosophy: Learn → Build → Deploy → Deliver → Optimize (AI/ML)
...
`Python` • `Java` • `Node.js` • `Spring Boot` • `REST APIs`
